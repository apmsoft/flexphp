...
class PushHistory extends Push{

    private $host = 'http://115.68.182.167/push/push_history/';
    private $cu = null;
    ...
    # 잔여량 확인
    #@ return array
    public function getHistory(array $fields_where)
    {
        # set header
        ...
        curl_setopt( $this->cu, CURLOPT_POSTFIELDS, json_encode($fields_where));
