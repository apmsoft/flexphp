...
include_once $push_sdk_root.'/classes/push/PushHistory.class.php';

# 잔여량 가져오기
try{
    $pushHistory = new PushHistory(_PUSH_PROJECTKEY_, _PUSH_ID_, _PUSH_PASSWD_);
    $resp = $pushHistory->getHistory(array(
        'to' => '1'
    ));
