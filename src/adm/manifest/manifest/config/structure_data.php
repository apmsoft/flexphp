...
$form->chkEngNumUnderline('feature_column','data 키', $req->feature_column, false);
...
if($req->feature_column && $req->feature_column !=''){
    $column_args = R::$config['data'][$req->feature_column];
}
...
$scheme_column_args =array(
    ...
    'then' => (is_array($column_args['then'])) ? $column_args['then'] : ''
);
