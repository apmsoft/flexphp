...
$form->chkEngNumUnderline('alarm_field','Model 변수 키', $req->alarm_field, true);
$form->chkNull('alarm_value','Model 변수 값', $req->alarm_value, true);
...
# add
R::$config['alarm'][$req->alarm_field] = $req->alarm_value;
