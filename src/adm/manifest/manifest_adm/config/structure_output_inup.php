...
$form->chkEngNumUnderline('output_field','Output 변수 키', $req->output_field, true);
$form->chkNull('output_value','Output 변수 값', $req->output_value, true);
...
# add
R::$config['output'][$req->output_field] = $req->output_value;
