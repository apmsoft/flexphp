...
$form->chkEngNumUnderline('vali_field','기능 퀄럼명', $req->vali_field, true);
$form->chkNull('vali_title','타이틀', $req->vali_title, true);
$form->chkEngNumUnderline('vali_filter','필터', $req->vali_filter, true);
$form->chkAlphabet('vali_filter','필터', $req->vali_required, false);
...
# add
R::$config[$req->feature][$req->vali_field] = array(
    "title"    => $req->vali_title,
    "required" => ($req->vali_required =='y') ? true : false,
    "filter"   => $req->vali_filter
);
