...
# 폼및 request값 체크
$form = new ReqForm();
$form->chkEngNumUnderline('vkey', '변수명(doc_id)', $req->vkey, true);
...
# Model
$model = new UtilModel();
$model->chkfilename = _ROOT_PATH_.DIRECTORY_SEPARATOR._DATA_.DIRECTORY_SEPARATOR."manifest_adm_"._LANG_.'.json';
$model->filename = (file_exists($model->chkfilename)) ? $model->chkfilename : 'manifest_adm';
