...
# config
include_once $path.DIRECTORY_SEPARATOR._SRC_.DIRECTORY_SEPARATOR.'adm'.DIRECTORY_SEPARATOR.'layout'.DIRECTORY_SEPARATOR.'layout'.DIRECTORY_SEPARATOR.'config.php';
...
$data = array(
    ...
    'description'  => R::$layout[$req->id]['description'],
    'url'          => (R::$layout[$req->id]['url'])? R::$layout[$req->id]['url'] : _SITE_HOST_.'/?act='.$req->id,
    'image'        => R::$layout[$req->id]['image'],
    'image_width'  => R::$layout[$req->id]['image_width'],
    'image_height' => R::$layout[$req->id]['image_height']
);
