...
$form->chkNumber('evtid', '미션', $req->evtid, true);
...
if(isset($is_myevent['id'])){
    out_json(array('result'=>'false','msg_code'=>'w_ongoing_game', 'msg'=>R::$sysmsg['w_ongoing_game']));
}

# insert
$db['evt_id']     = $req->evtid;
$db['muid']       = $userinfo['id'];
$db['start_date'] = date('Y-m-d');
$db['start_time'] = date('H:i');
$db->insert(R::$tables['myevents']);
