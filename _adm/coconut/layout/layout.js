    ...
    app.initialize({
        "adm_layout" : {
            "list" : {
                ...
                "title":null,
                "frame": null,
                "template": "/_adm/coconut/layout/list#tpl_layout_listview",
                "value": app.src+"/adm/layout/layout/list"
            },
            "edit" : {
                "panel": "bottom",
                "title":"수정",
                ...
                "value": app.src+"/adm/layout/layout/edit"
            },
            "post" : {
                "panel": "bottom",
                "title":"등록",
        ...
        onCreateView: function() 
        {
            ...
            var LayoutActivity = {
                doList: function(params) {
                    ...
                    // panel
                    var panel_setting = app.docs.adm_layout.list; // SETTING VALUE
                            ...
                            $(panel.id+'_docs_contents').html(tpl).promise().done(function() 
                            {
                                ...
                                $(panel.id+'_docs_contents .raw-del').on('click', function() 
                                {
                                    ...
                                    if (!_.isUndefined(this_data_id)) {
                                        ...
                                        if(cf){
                                            var send_params = {
                                                doc_id: "adm_layout/delete",
                                                id : this_data_id
                                            };
                                            _.extend(send_params, params);
                            
                                            ProgressBar.show_progress();
                                            DocAsyncTask.doPostMessage(app.src+"/adm/layout/layout/delete", send_params, {
                ...
                doPost: function() {
                    var self = this;
                    var send_params = {
                        doc_id: 'adm_layout/post'
                    };
    
                    // panel
                    var panel_setting = app.docs.adm_layout.post; // SETTING VALUE
                    var panel = Panel.onStart(panel_setting);
                        ...
                        success: function(tpl, resp) {
                            $(panel.id+'_docs_contents').html(tpl).promise().done(function() {
                                ...
                                DocAsyncTask.doSubmit(panel.id+'_docs_contents #theDefaultForm', function(form_params)
                                {
                                    ...
                                    var _send_params = {
                                        doc_id : 'adm_layout/insert'
                                    };
                                    _.extend(_send_params,form_params);

                                    DocAsyncTask.doPostMessage(app.src+"/adm/layout/layout/insert", _send_params, {
                                        success : function(resp){
                                            ProgressBar.close_progress();
                                            Toast.show('',resp.msg,2000, {style:'success'});
                ...
                doEdit: function(params) {
                    var self = this;
                    var send_params = {
                        doc_id: "adm_layout/edit",
                        cache :false
                    };
                    _.extend(send_params, params);
    
                    // panel
                    var panel_setting = app.docs.adm_layout.edit; // SETTING VALUE
                    var panel = Panel.onStart(panel_setting);
                        ...
                        success: function(tpl, resp) {
                            ...
                            $(panel.id+'_docs_contents').html(tpl).promise().done(function() 
                            {
                                ...
                                DocAsyncTask.doSubmit(panel.id+'_docs_contents #theDefaultForm', function(form_params)
                                {
                                    ...
                                    var _send_params = {
                                        doc_id : 'adm_layout/update'
                                    };
                                    _.extend(_send_params,form_params);

                                    DocAsyncTask.doPostMessage(app.src+"/adm/layout/layout/update", _send_params, {
                                        success : function(resp){
                                            ProgressBar.close_progress();
                                            Toast.show('',resp.msg,2000, {style:'success'});
            ...
            LayoutActivity.doList(UrlUtil._url_params);
        }
    });
