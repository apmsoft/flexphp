        ...
        onCreateView: function() 
        {
            ...
            var ProgramActivity = {
                doList: function(params) {
                    ...
                    // panel
                    var panel_setting = app.docs[layout.manifid].list; // SETTING VALUE
                ...
                doPost: function() {
                    var self = this;
                    var send_params = {
                        doc_id: layout.manifid+'/post'
                    };
    
                    // panel
                    var panel_setting = app.docs[layout.manifid].post; // SETTING VALUE
                    panel_setting.title = layout.title+' '+panel_setting.title;
                    var panel = Panel.onStart(panel_setting);
                ...
                doView: function(params) {
                    ...
                    var send_params = {
                        doc_id: layout.manifid+'/view'
                    };
                    _.extend(send_params, params);

                    // panel
                    var panel_setting = app.docs[layout.manifid].view; // SETTING VALUE
                    panel_setting.title = layout.title+' '+panel_setting.title;
                    var panel = Panel.onStart(panel_setting);
                    ...
                    UrlUtil.pushState('doProgramView', '', app.service_root_dir+'_adm/?'+$.param(UrlUtil._url_params));
                ...
                doEdit: function(params) {
                    var self = this;
                    var send_params = {
                        doc_id: layout.manifid+'/edit',
                        cache :false
                    };
                    _.extend(send_params, params);
    
                    // panel
                    var panel_setting = app.docs[layout.manifid].edit; // SETTING VALUE
                    var panel = Panel.onStart(panel_setting);
            ...
            ProgramActivity.doList(UrlUtil._url_params);
        }
    });
