    ...
    app.initialize({
        "adm_device" : {
            "list" : {
                ...
                "title":null,
                "frame": null,
                "template": "/_adm/coconut/device/list#tpl_device_listview",
        ...
        onCreateView: function() 
        {
            ...
            var DeviceActivity = {
                doList: function(params) {
                    ...
                    // panel
                    var panel_setting = app.docs.adm_device.list; // SETTING VALUE
                    ...
                    DocAsyncTask.doGetContents(panel_setting, send_params,{
                        success: function(tpl, resp) {
                            $(panel.id+'_docs_contents').html(tpl).promise().done(function() 
                            {
                                ...
                                // 검색
                                $(panel.id+'_docs_contents #theDeviceListViewForm').submit(function(event) {
                ...
                doPost: function() {
                    var self = this;
                    var send_params = {
                        doc_id: 'adm_device/post'
                    };
    
                    // panel
                    var panel_setting = app.docs.adm_device.post; // SETTING VALUE
                    var panel = Panel.onStart(panel_setting);
                    ...
                    UrlUtil.pushState('doDevicePost', '', app.service_root_dir+'_adm/?'+$.param(UrlUtil._url_params));
                ...
                doEdit: function(params) {
                    var self = this;
                    var send_params = {
                        doc_id: "adm_device/edit",
                        cache :false
                    };
                    _.extend(send_params, params);
    
                    // panel
                    var panel_setting = app.docs.adm_device.edit; // SETTING VALUE
                    var panel = Panel.onStart(panel_setting);
                    ...
                    UrlUtil.pushState('doDeviceEdit', '', app.service_root_dir+'_adm/?'+$.param(UrlUtil._url_params));
            ...
            DeviceActivity.doList(UrlUtil._url_params);
        }
    });
