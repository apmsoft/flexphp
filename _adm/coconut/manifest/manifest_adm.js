    ...
    app.initialize({
        "adm_manifestadm" : {
            "list" : {
                ...
                "value": app.src+"/adm/manifest/manifest_adm/list"
            },
            "edit" : {
                "panel": "bottom",
                "title":"수정",
                ...
                "value": app.src+"/adm/manifest/manifest_adm/edit"
            },
            "post" : {
                "panel": "bottom",
                "title":"등록",
                ...
                "value": app.src+"/adm/manifest/manifest_adm/post"
            }
        }
    });
        ...
        onCreateView: function() 
        {
            ...
            var ManifasetAdmActivity = {
                doList: function(params) {
                    ...
                    // panel
                    var panel_setting = app.docs.adm_manifestadm.list; // SETTING VALUE
                            ...
                            $(panel.id+'_docs_contents').html(tpl).promise().done(function() 
                            {
                                ...
                                $(panel.id+'_docs_contents .raw-del').on('click', function() 
                                {
                                    ...
                                    if (!_.isUndefined(this_data_id)) {
                                        ...
                                        if(cf){
                                            var send_params = {
                                                doc_id: "adm_manifestadm/delete",
                                                id : this_data_id
                                            };
                                            _.extend(send_params, params);
                            
                                            ProgressBar.show_progress();
                                            DocAsyncTask.doPostMessage(app.src+"/adm/manifest/manifest_adm/delete", send_params, {
                                ...
                                $(panel.id+'_docs_contents .btn-edit-config').on('click', function() {
                                    ...
                                    require(['/_adm/coconut/config/config.js'], function(ConfigActivity) {
                                        ...
                                        ConfigActivity.doEdit('manifest_adm',send_params);                          
                                    });
                                });
                                ...
                                $(panel.id+'_docs_contents .btn-post-config').on('click', function() {
                                    ...
                                    require(['/_adm/coconut/config/config.js'], function(ConfigActivity) {
                                        ...
                                        ConfigActivity.init('manifest_adm',send_params, function(manifid){
                                            self.doList(params);
                                        });                          
                                    });
                                });
                                ...
                                $(panel.id+'_docs_contents .btn-remove-config').on('click', function() {
                                    ...
                                    {
                                        ProgressBar.show_progress();
                                        DocAsyncTask.doPostMessage(app.src+"/adm/manifest/manifest_adm/config/delete", {
                                            manifid : this_manifid,
                                            cfid : this_cfid
                                        }, 
                                        {
                ...
                doPost: function() {
                    var self = this;
                    var send_params = {
                        doc_id: 'adm_manifestadm/post'
                    };
    
                    // panel
                    var panel_setting = app.docs.adm_manifestadm.post; // SETTING VALUE
                    var panel = Panel.onStart(panel_setting);
                        ...
                        success: function(tpl, resp) {
                            $(panel.id+'_docs_contents').html(tpl).promise().done(function() 
                            {
                                ...
                                DocAsyncTask.doSubmit(panel.id+'_docs_contents #theManifestForm', function(form_params)
                                {
                                    ...
                                    var _send_params = {
                                        doc_id : 'adm_manifestadm/insert'
                                    };
                                    _.extend(_send_params,form_params);

                                    DocAsyncTask.doPostMessage(app.src+"/adm/manifest/manifest_adm/insert", _send_params, {
                                        success : function(resp){
                                            ProgressBar.close_progress();
                                            Toast.show('',resp.msg,2000, {style:'success'});
                ...
                doEdit: function(params) {
                    ...
                    var send_params = {
                        doc_id: "adm_manifestadm/edit",
                        cache :false
                    };
                    _.extend(send_params, params);
    
                    // panel
                    var panel_setting = app.docs.adm_manifestadm.edit; // SETTING VALUE
                    var panel = Panel.onStart(panel_setting);
                        ...
                        success: function(tpl, resp) {
                            ...
                            $(panel.id+'_docs_contents').html(tpl).promise().done(function() 
                            {
                                ...
                                DocAsyncTask.doSubmit(panel.id+'_docs_contents #theManifestForm', function(form_params)
                                {
                                    ...
                                    var _send_params = {
                                        doc_id : 'adm_manifestadm/update'
                                    };
                                    _.extend(_send_params,form_params);

                                    DocAsyncTask.doPostMessage(app.src+"/adm/manifest/manifest_adm/update", _send_params, {
                                        success : function(resp){
                                            ProgressBar.close_progress();
                                            Toast.show('',resp.msg,2000, {style:'success'});
